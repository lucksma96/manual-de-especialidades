...
1. Saber operar devidamente o tipo de fogão que há em sua casa. Saber como prevenir pequenos incêndios por óleo ou gordura em seu fogão e saber como apagálos. Conhecer as medidas de segurança enquanto estiver cozinhando, incluindo a preocupação com crianças pequenas.
...
a) Temperatura máxima de lavagem

b) Lavar à mão

c) Não lavar

- d) Temperatura máxima da base do ferro de passar a 200°
- e) Temperatura máxima da base do ferro de passar a 150°
- f) Temperatura máxima da base do ferro de passar a 110°

g) Não passar

- h) Secagem em varal
- i) Secagem na horizontal
- j) Secagem por gotejamento
- k) Permitido alvejante com cloro
- I) Não alvejar / não branquear
- m) Não limpar a seco
...
b) Produtos à base de peróxido de hidrogênio (água oxigenada)
...
**12.** Passar, dobrar e quardar corretamente os sequintes tipos de roupas:
...
- f) Camiseta
- g) Uniforme de gala
- 12. Cumprir os seguintes requisitos:

a) Lavar, dobrar e guardar as roupas de sua família por um mês (caso use máquina de lavar) ou por uma semana (caso seja à mão).

b) Lavar à mão (no tanque, na bacia, no rio) corretamente, pelo menos, duas peças de roupa (peças íntimas não contam).

c) Passar, dobrar e guardar corretamente as suas roupas durante, pelo menos, duas semanas.

d) Manter o seu guarda-roupa ou cômoda organizados por, no mínimo, um mês. Apresentar relatório com suas observações sobre facilidades e dificuldades no processo.
...
- 9. Manter a sua casa limpa e organizada por, no mínimo, 1 mês, incluindo:
  - a) Lavar o chão
  - b) Tirar o pó
  - c) Trocar as roupas de cama, capas de almofadas e forros e toalhas de mesa
  - d) Arrumar as camas
  - e) Guardar tudo em seu devido lugar
  - f) Lavar o banheiro
  - g) Tirar o lixo
...
- 9. Quais são os sinais de que uma conserva não está mais adequada para o consumo? 10. O que é botulismo? Pelo que é causado? Quais são os sinais e sintomas dessa doenca?
...
5. O que você e sua família podem fazer para economizar água, energia elétrica e telefone? 6. O que é inflação?
...
16. Montar um orçamento familiar e manter um relatório preciso de entradas e saídas durante 6 meses (desbravadores mais jovens podem fazer isto em conjunto com os

pais); os garotos e garotas que vivem em fazendas, podem fazer relatórios ligados à agricultura, laticínios ou gado.

17. Ler Malaquias 3:8-12 e escrever, no mínimo, 250 palavras sobre o que significa, para você, ser um mordomo fiel.

![](_page_6_Picture_0.jpeg)

1. Explicar a diferença entre o valor nutricional da farinha integral e da farinha branca. 2. Comparar o fermento biológico e o fermento químico. Como é a ação de cada um deles na massa? Para quais receitas cada um deles é mais indicado?
...
c) Bolo de frutas ou castanha

d) Bolo sem a utilização de leite ou derivados

e) Bolo que não contenha glúten
...
b) Não assada (apenas de massa assada no forno): frutas frescas, gelatina, etc.

c) Salgada (vegetariana de qualquer sabor)
...
5. Saber por quanto tempo os seguintes alimentos podem ser quardados na geladeira: e) Carne a) Leite **b**) Ovos crus f) Sobras de comida c) Ovos cozidos g) Hortalicas d) Maionese
...
- 1. Descrever o uso apropriado do seguinte:
  - a) Fita métrica
  - **b**) Tesouras
  - c) Agulhas de vários tamanhos e tipos
  - d) Giz
- 2. Familiarizar-se com uma máquina de costura. Identificar:
  - a) Puxador de linha
  - b) Pé calçador
  - c) Levantador de pé calçador
  - d) Alimentador da bobina
  - e) Serrilha
...
- 6. Dizer o significado de:
  ...
  - d) Enviesado
  - e) Nesga
- 7. Saber como cerzir (remendar) corretamente.
...
- 6. Preparar e servir para sua unidade uma comida típica que não seja do seu país. 7. Conhecer, ao menos, uma comida típica de cada estado/região de seu país e preparar 2 delas para sua família ou unidade.
